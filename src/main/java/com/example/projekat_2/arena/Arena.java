...
import com.example.projekat_2.Utilities;
...
public class Arena extends Group {
    ...
    public void update(double arenaDefaultFactor){
        this.rotateX.setAngle(this.rotateX.getAngle()*arenaDefaultFactor);
        this.rotateZ.setAngle(this.rotateZ.getAngle()*arenaDefaultFactor);
    }
}
